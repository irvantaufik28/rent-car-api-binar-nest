...
const jwt_strategy_1 = require("../../common/helper/jwt/jwt.strategy");
...
AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            jwt_1.JwtModule.register(jwt_config_1.jwtConfig), typeorm_1.TypeOrmModule.forFeature([user_entity_1.UserEntity])
        ],
