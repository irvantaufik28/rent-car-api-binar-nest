...
exports.newmigration1677468916284 = void 0;
class newmigration1677468916284 {
    constructor() {
        this.name = 'newmigration1677468916284';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "notifcation" ("id" SERIAL NOT NULL, "recipient_id" integer NOT NULL, "sender_id" integer NOT NULL, "content" character varying NOT NULL, CONSTRAINT "PK_1ed8a03856b67f4c3bc380831ed" PRIMARY KEY ("id"))`);
...
exports.newmigration1677468916284 = newmigration1677468916284;
//# sourceMappingURL=1677468916284-newmigration.js.map