      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            ...
            <ul>
              <li> <a href="#"><img src={icon_facebook} alt='icon_facebook' /></a></li>
              <li> <a href="#"><img src={icon_instagram} alt='icon_instagram' /></a></li>
              <li> <a href="#"> <img src={icon_mail} alt='icon_mail' /></a></li>
              <li> <a href="#"><img src={icon_twitch} alt='icon_twitch' /></a></li>
              <li> <a href="#"><img src={icon_twitter} alt='icon_twitter' /></a></li>
            </ul>
            </div>
          </div>
